    ...
    def decomposition(
        ...
        **kwargs : dict
        ...
        try:
            ...
            if algorithm == "SVD":
                factors, loadings, explained_variance, mean = learn.svd_pca(
                    data_,
                ...
                X, E, U, S, V = learn.rpca_godec(data_, rank=output_dimension, **kwargs)
                ...
                if return_info:
                    ...
                    L, R = learn.orpca(data_, rank=output_dimension, **kwargs)
                ...
                if return_info:
                    ...
                    W, H = learn.ornmf(data_, rank=output_dimension, **kwargs)
    ...
    def blind_source_separation(
        ...
        **kwargs : dict
        ...
        if whiten_method is not None:
            ...
            factors, invsqcovmat = learn.whiten_data(
